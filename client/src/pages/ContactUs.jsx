        ...
        <div className="min-h-screen flex items-center bg-gradient-to-br">
            <div className="w-full max-w-4xl mx-auto">
                <div className="p-8 bg-purple-200 rounded-lg shadow-lg">
                    ...
                    <form ref={form} onSubmit={handleEmail} className="space-y-4">
                        ...
                        ></textarea>
                        <button type="submit" className="btn-primary w-1/2 py-3 rounded-md text-white font-bold bg-full-purple transition duration-300 ease-in-out">
                            Submit
                        </button>
                    </form>
                    <div className="alert-contatiner pt-2">
                        <Collapse in={open} className="alert">
                            <Alert
                                ...
                                sx={{ mb: 2 }}
                            >
                                Message Sent! Daia will get back to you as soon as possible.
                            </Alert>
                        </Collapse>
                    </div>
                </div>
